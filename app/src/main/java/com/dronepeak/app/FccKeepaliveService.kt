...
class FccKeepaliveService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.dronepeak.app.START_KEEPALIVE"
        const val ACTION_STOP = "com.dronepeak.app.STOP_KEEPALIVE"
        private const val INTERVAL_MS = 2000L
        private const val PREFS_NAME = "dronepeak"
    ...
    private fun createNotification(): Notification {
        val language = AppLanguage.fromPref(
